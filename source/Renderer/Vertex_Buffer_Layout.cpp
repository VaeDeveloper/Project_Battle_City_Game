...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Vertex_Buffer_Layout::Vertex_Buffer_Layout() : Stride(0), Layout_Elements(0) {}
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
{
    Layout_Elements.push_back({count, GL_FLOAT, normalized, count * static_cast<unsigned>(sizeof(GLfloat))});
